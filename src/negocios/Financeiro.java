...
public class Financeiro {
    ...
    public void deletar(String codigo){
        if(this.Procurar(codigo).getCodigo() == null){
            ...
            //espaÃ§o para registrar pagamento
            
        }

    }
    
    public void pagarConta(String codigo){ // experimental, no momento esse metodo Ã© de baixa imortancia;
        Conta aux  = this.Procurar(codigo);
    ...
    public void ListarContas(TipoConta tipo){
        ...
        Conta conta;
        System.out.println("");
        System.out.print("Listando Contas Ã  ");
